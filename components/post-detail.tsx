...
import {Bookmark, Eye, Flag, MessageCircle, Share2, Trash2} from "lucide-react"
...
export function PostDetail({postId}: Readonly<{ postId: string }>) {
    ...
    const userMockData = {
        ...
        recentActivity: ["Posted a new story", "Commented on 3 posts", "Joined a writing group"],
    }
            ...
            <Card>
                <CardContent className="p-8">
                    ...
                    <div className="flex items-start justify-between mb-6">
                        <div className="flex-1">
                            ...
                            <div className="flex items-start justify-between mb-2">
                                <h1 className="text-2xl font-bold text-gray-900 flex-1">{postData.afterTitle}</h1>
                            ...
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-sm text-gray-500">{postData.createdAt}</span>
                                </div>
                    ...
                    <div className="prose prose-gray max-w-none mb-6">
                        <div
                            className="whitespace-pre-line text-gray-800 leading-relaxed">{postData.afterContent}</div>
                    </div>
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-2">
                                {reactionEmojis.map((emoji) => (
                                  ...
                                  {postMockData.reactions[emoji as keyof typeof postMockData.reactions]}
                                </span>
                                    </div>
                                ))}
                            </div>
