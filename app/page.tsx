...
const generatePosts = (page: number) => {
  ...
  for (let i = 1; i <= 10; i++) {
    posts.push({
      ...
      time: `2024-12-${17 - Math.floor((baseId + i) / 10)} ${14 - (i % 12)}:${
        30 + (i % 30)
      }`,
      emotion: [
        "melancholy",
      ...
      preview: `This is a beautiful literary piece that explores the depths of human emotion and experience. Post number ${
        baseId + i
      } brings unique insights into the world of creative writing and artistic expression.`,
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Latest Literary Creations
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover the newest posts from our talented community of writers and
            poets
          </p>
        </div>
        ...
        {!hasMore && posts.length > 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Explore more content by browsing categories
            </p>
            <Link href="/posts">
